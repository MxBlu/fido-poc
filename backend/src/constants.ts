 ...
 *
 * Setting this to undefined means either kind of authenticator is accepted
*/
export const FIDO2_ATTACHMENT_REQUIREMENT: Attachment = undefined;
/** 
 ...
 * 
 * * Setting this to false means its up to the platform to decide if it wants to store a resident key
 * * Setting this to true will require the platform to store a resident key
 */
export const FIDO2_REQUIRE_RESIDENT_KEY = false;
/**
 ...
 * 
 * * Setting this to undefined will let the platform decide whether to verify the user or not
 ...
 */
export const FIDO2_USER_VERIFICATION_REQUIREMENT: UserVerification = undefined;