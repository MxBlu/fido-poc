/**
 * Interfaces and models copied across from the backend code
 * 
 * All response interfaces have been modified to assume a successful response (e.g. LoginStartResponse.token is not null)
 */
